...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Clique Turbo...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/CliqueTurbo.zip /home/deploy/${instancia_add}/
EOF
...
system_unzip_CliqueTurbo() {
  print_banner
  printf "${WHITE} 💻 Extraindo o Clique Turbo...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - deploy <<EOF
  unzip /home/deploy/${instancia_add}/CliqueTurbo.zip -d /home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Clique Turbo...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do Clique Turbo...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Bloquear o Clique Turbo...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Clique Turbo de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do Clique Turbo de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
