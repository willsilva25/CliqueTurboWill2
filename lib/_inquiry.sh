...
#  
#  print_banner
#  printf "${WHITE} 💻 Insira o link do GITHUB do Clique Turbo que deseja instalar:${GRAY_LIGHT}"
#  printf "\n\n"
#  read -p "> " link_git
#}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Clique Turbo, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Clique Turbo\n"
  printf "   [1] Atualizar Clique Turbo\n"
  printf "   [2] Deletar Clique Turbo\n"
  printf "   [3] Bloquear Clique Turbo\n"
  printf "   [4] Desbloquear Clique Turbo\n"
  printf "   [5] Alter. dominio Clique Turbo\n"
  printf "\n"
  read -p "> " option
